                                    ...
                                    <div class="flex flex-col">
                                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                                <h2 style="font-size: 1.5em;" class="mb-6">@lang('common.announcement_list')</h2>
                                                <div class="overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                                    <div class="flex items-center justify-end mt-4 mb-4">
                                                    <x-button class="ml-1 mr-1">
                                                        <a href="{{route('announcement.create')}}">
                                                            <i class="fas fa-plus"></i> @lang('common.new_announcement')
                                                        </a>
                                                    </x-button>
                                                </div>
                                                                ...
                                                                <div class="flex items-center">
                                                                    <div class="">
                                                                        ...
                                                                        <div class="text-sm text-gray-500">
                                                                            {{\Carbon\Carbon::parse($announcement->created_at)->format('d-m-Y H:i:s')}}
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td class="px-1 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                                <a href="{{route('announcement.show', $announcement->id)}}"
                                                                   class="p-1 pl-3 pr-3 transition-colors duration-50 transform bg-indigo-500 hover:bg-blue-400 text-gray-100 text-sm rounded-lg focus:border-4 border-indigo-300 mr-5"><i
                                                                    ...
                                                                    <button type="submit"
                                                                            onclick='modalShow("{{route('announcement.destroy', $announcement->id)}}")'
