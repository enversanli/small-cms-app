        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <a href="/admin/validators" class="border w-40 border-teal-500 text-teal-500 block rounded-sm font-bold py-2 px-3 mr-2 flex items-center hover:bg-black-500 hover:text-gray-500">
                    ...
                    <div class="py-12">
                        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            <div class="mt-24 space-y-20">
                                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                                    <h1>@lang('common.new_validator')</h1>
                                    <div class="p-6 bg-white border-b border-gray-200">
