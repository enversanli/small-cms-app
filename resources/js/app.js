...
Vue.component('service-detail-component', require('./components/ServiceDetailComponent.vue').default);
Vue.component('service-guide-component', require('./components/ServiceGuideComponent.vue').default);
